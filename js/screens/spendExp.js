                ...
                var exp1cost = ((game.data.exp1 + 1) * 10);
                  ...
                  me.game.world.addChild(new (me.Renderable.extend({
                    ...
                    draw: function(renderer){
                        ...
                        this.font.draw(renderer.getContext(), "F1:  INCREASE GOLD PRODUCTION:  CURRENT LEVEL: " + game.data.exp1.toString() + "COST: " + exp1cost, this.pos.x + 200, this.pos.y + 100);
                        this.font.draw(renderer.getContext(), "F2: ADD STARTING GOLD ", this.pos.x + 200, this.pos.y + 150);
