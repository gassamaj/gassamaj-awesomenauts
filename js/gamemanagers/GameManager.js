    ...
    setBuyText: function() {
        game.data.buytext = new (me.Renderable.extend({
            ...
            draw: function(renderer) {
                ...
                this.font.draw(renderer.getContext(), "Skill 1: Increase Damage. Current Level: " + game.data.ski112 + " Cost: " + ((game.data.exp1 + 1) * 10), this.pos.x, this.pos.y);
                ...
                this.font.draw(renderer.getContext(), "O Ability:  Speed  Burst. Current  Level: " + game.data.ability1 + " Cost: " + ((game.data.exp4 + 1) * 10), this.pos.x, this.pos.y + 160);
